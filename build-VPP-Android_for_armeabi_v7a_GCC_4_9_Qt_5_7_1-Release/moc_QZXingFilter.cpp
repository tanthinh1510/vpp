...
const QMetaObject QZXingFilter::staticMetaObject = {
    { &QAbstractVideoFilter::staticMetaObject, qt_meta_stringdata_QZXingFilter.data,
      qt_meta_data_QZXingFilter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QZXingFilter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QZXingFilter.stringdata0))
        return static_cast<void*>(const_cast< QZXingFilter*>(this));
...
const QMetaObject QZXingFilterRunnable::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QZXingFilterRunnable.data,
      qt_meta_data_QZXingFilterRunnable,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QZXingFilterRunnable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QZXingFilterRunnable.stringdata0))
        return static_cast<void*>(const_cast< QZXingFilterRunnable*>(this));
    if (!strcmp(_clname, "QVideoFilterRunnable"))
        return static_cast< QVideoFilterRunnable*>(const_cast< QZXingFilterRunnable*>(this));
